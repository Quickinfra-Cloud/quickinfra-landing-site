...
const PARTNER_TYPES = [
  {
    ...
    perks: [
      ...
      "Co-developed solution bundles",
      "Technical co-innovation sprints",
...
function PartnerWidget() {
  ...
  useEffect(() => {
    ...
    const iv = setInterval(
      () => setActiveLine((n) => (n + 1) % PARTNER_ACTIVITY.length),
      1500,
    );
      ...
      <div className="h-full">
        <div className="h-full flex flex-col rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-900 shadow-2xl shadow-orange-500/10 dark:shadow-black/50">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            {PARTNER_ACTIVITY.map(
              ({ company, type, value, color, time }, i) => (
                <div
                  key={i}
                  ...
                  style={{
                    background: activeLine === i ? color + "08" : "transparent",
                  }}
                >
                  <div
  ...
  return (
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              >
                ...
                />
                <span className="text-xs font-bold tracking-widest text-orange-600 dark:text-orange-400 uppercase">
                  Partner Programme
                </span>
              </div>
              ...
              >
                Join forces with QuickInfra to level up your cloud service
                offerings and secure a competitive edge. Leverage our cloud
                solutions to deliver fully automated DevOps, fast migration, and
                significant cost savings to your clients.
              </p>
              ...
              >
                {[
                  ["50+", "Active partners"],
                  ["95%", "Retention rate"],
                  ["3×", "Avg revenue growth"],
                ].map(([v, l]) => (
                  <div key={l}>
                    <div className="text-sm font-extrabold text-orange-500 dark:text-orange-400">
                      {v}
                    </div>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[10px] font-bold tracking-widest uppercase text-orange-500 dark:text-orange-400 mb-3">
              Partnership Types
            </p>
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
              Flexible Opportunities for Every Partner
            </h2>
            <p className="text-base text-slate-500 dark:text-slate-400 font-light max-w-lg mx-auto">
              Three partnership models designed to fit exactly where you are in
              your growth journey.
            </p>
          </div>
                ...
                <div className="p-7 sm:p-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div
                      ...
                      style={{
                        ...
                        border: `2px solid ${active.color}25`,
                        color: active.color,
                      }}
                    >
                      <active.icon size={26} />
                  ...
                  <Link
                    ...
                    style={{
                      ...
                      boxShadow: `0 4px 16px ${active.color}35`,
                    }}
                  >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-y border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {CLOUD_PARTNERS.map(({ name, full, tag, color, logo}) => (
              <div
                key={name}
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
              A Programme That Keeps Your Growth First
            </h2>
            <p className="text-base text-slate-500 dark:text-slate-400 font-light max-w-lg mx-auto">
              Three pillars of the QuickInfra partner programme — built to make
              your growth as the priority.
            </p>
          </div>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 border-y border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[10px] font-bold tracking-widests uppercase text-orange-500 dark:text-orange-400 mb-3">
              Why Partner
            </p>
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
              Why Partner with QuickInfra?
            </h2>
            <p className="text-base text-slate-500 dark:text-slate-400 font-light max-w-lg mx-auto">
              Six reasons why the fastest-growing cloud resellers and solution
              providers choose QuickInfra.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHY_PARTNER.map(({ icon: Icon, title, color, desc }) => (
              ...
              >
                ...
                <h3 className="text-sm font-extrabold mb-2.5 leading-snug tracking-tight group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">
                  {title}
                </h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 font-light leading-relaxed">
                  {desc}
      ...
      <section className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          <p className="text-[10px] font-bold tracking-widest uppercase text-orange-500 dark:text-orange-400 mb-6">
            Let's Grow Together
          </p>
          <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight mb-6">
            Ready to make us your
            <br />
            growth partner?
          </h2>
          <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-light leading-relaxed mb-10">
            Join 50+ technology, solution, and reseller partners who are growing
            faster with QuickInfra. Get in touch and we'll match you to the
            right partnership model.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/contact"
              className="flex items-center gap-2 px-7 py-3.5 rounded-xl text-sm font-bold bg-orange-500 hover:bg-orange-400 text-white shadow-xl shadow-orange-500/25 hover:shadow-orange-500/40 transition-all hover:-translate-y-0.5"
            >
              Become a Partner <ArrowRight size={16} />
            </Link>
          </div>
          <p className="mt-6 text-[10px] font-bold tracking-widest uppercase text-slate-300 dark:text-slate-700">
            ISO/IEC 27001 · AWS Qualified Software · 95% Partner Retention
          </p>
        </div>
      </section>
    </div>
